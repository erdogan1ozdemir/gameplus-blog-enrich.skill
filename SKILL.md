...
- **Tür rozeti → GFN kategorisi iç linki:** Tür GFN kategorilerinden birine fit ediyorsa rozet o kategori sayfasına iç link olur (`category_url_for(badge)`). **YALNIZCA tek/saf rozet linklenir; birleşik/çift rozet (Aksiyon-RPG, Aksiyon-Macera) linklenmez.** **Dedup YOK** — aynı yazıda eşleşen her rozet linklenir (sadece oyun başlığında; liste/tabloda değil). Detay: `content-rules.md` kural 12.
